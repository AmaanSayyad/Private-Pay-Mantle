      ...
      <ModalContent className="relative flex flex-col rounded-4xl items-center justify-center gap-5 p-6">
        ...
        <div className="flex flex-col items-center gap-2 py-2">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full">
            <img src="https://www.mantle.xyz/favicon.ico" alt="Mantle Logo" className="h-5 w-auto object-contain" />
            <span className="text-sm font-medium text-gray-700">Mantle Network</span>
          </div>
        </div>
